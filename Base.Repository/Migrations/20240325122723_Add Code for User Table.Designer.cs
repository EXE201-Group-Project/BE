...
namespace Base.Repository.Migrations
{
    ...
    [Migration("20240325122723_Add Code for User Table")]
    partial class AddCodeforUserTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Base.Repository.Entity.Route", b =>
                {
                    b.HasOne("Base.Repository.Entity.Location", "Destination")
                        .WithOne("EndPointRoute")
                        .HasForeignKey("Base.Repository.Entity.Route", "EndPointId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Base.Repository.Entity.Location", "Origin")
